        ...
        <header className="px-12 py-8 border-b border-white/5 flex justify-between items-center backdrop-blur-md sticky top-0 z-30 bg-[#020617]/80">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right">
                <p className="text-[10px] font-black text-white">HR ADMIN 01</p>
                <p className="text-[8px] font-black text-indigo-500 tracking-widest">GLOBAL ACCESS</p>
            </div>
          </div>
        </header>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 bg-slate-900/20 border border-white/5 rounded-[3.5rem] overflow-hidden shadow-2xl">
              <div className="px-10 py-8 border-b border-white/5 flex justify-between items-center bg-white/5">
                ...
                <button className="text-[9px] font-black text-indigo-500 hover:text-indigo-400 transition-colors tracking-widest">VIEW ALL APPLICANTS</button>
              </div>
              <div className="divide-y divide-white/5">
                {[
                  ...
                  <div key={i} className="px-10 py-6 flex justify-between items-center hover:bg-white/5 transition-all">
                    <div className="flex items-center gap-5">
                        <div className="w-10 h-10 rounded-xl bg-indigo-600/10 flex items-center justify-center text-indigo-500 text-[10px] font-black">
                    ...
                    <div className="flex items-center gap-10">
                        ...
                        <ArrowUpRight className="w-5 h-5 text-slate-700 hover:text-indigo-500 cursor-pointer transition-colors" />
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-6">
              <h3 className="text-xs font-black text-indigo-500 tracking-[0.4em] px-4">HR Compliance Radar</h3>
              <div className="space-y-4">
                {[
                    ...
                    <div key={i} className={`p-8 rounded-[2.5rem] border ${
